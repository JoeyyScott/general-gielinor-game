...
const questions = [{
        ...
        answer4: 'mIRC',
        correct: '3', //Java
        messageCorrect: `<img src="assets/images/answers/java.png" class="question-img" alt="Java Logo Image">
        <p>It was Java. The Gower brothers originally created RuneScape classic all the way back in 2001! The game is alive today and is celebrating 20 years of being around, how incredible is that?<br> You can chekc out Jagex' website <a href="https://www.jagex.com/en-GB/" target="blank">here!</a></p>`,
    ...
    },
    {
        ...
        answer4: '35',
        correct: '4', //35
        messageCorrect: `<img src="assets/images/answers/raw-tuna.png" class="question-img" alt="Raw Tuna Image">
        <p>It is level 35 to catch raw tuna. You can fish them at 55 fishing without a harpoon if you have unlocked the Barbarian ways of barehanded Fishing! Either way you'll get 80 Fishing experience!<br> Check out the wiki for Raw tuna <a href="https://runescape.wiki/w/Raw_tuna" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        answer4: 'Aggie',
        correct: '3', //Ned
        messageCorrect: `<img src="assets/images/answers/ned.png" class="question-img" alt="Ned Image">
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/apothecary.png" class="question-img" alt="Apothecary Image">
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/trimcomp.png" class="question-img" alt="Trimmed Completionist Image">
    ...
    },
    {
        ...
        answer4: '43',
        correct: '4', //43
        messageCorrect: `<img src="assets/images/answers/praymelle.png" class="question-img" alt="Pray Melle Image">
    ...
    },
    {
        ...
        answer4: '2009',
        correct: '2', //2007
        messageCorrect: `<img src="assets/images/answers/grandexchange.png" class="question-img" alt="GE Image">
    ...
    },
    {
        ...
        answer4: 'AKS',
        correct: '3', //ALS
        messageCorrect: `<img src="assets/images/answers/fairyring.png" class="question-img" alt="Fairy Ring Image">
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/magictree.png" class="question-img" alt="Magic Tree Image">
    ...
    },
    {
        ...
        answer4: '80',
        correct: '3', //75
        messageCorrect: `<img src="assets/images/answers/plaguesend.png" class="question-img" alt="Plagues End Image">
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/grandseedpod.png" class="question-img" alt="Grand seed pod Image">
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/trollheimtelly.png" class="question-img" alt="Trollheim Teleport Image">
        <p>It was 2 Law 2 Fire. You unlock this teleport after completing Eadgar's Ruse quest. It will teleport you to the center of Trollheim and is used for herb runs and questing.<br> Check out the wiki for the Trollheim Teleport <a href="https://runescape.wiki/w/Trollheim_Teleport" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/babyyagashouse.png" class="question-img" alt="Baby Yaga's House Image">
        <p>It was Baby Yaga's House. You unlock this skilling pet whilst training Construction. Some activities do not award the chance to roll for the pet such as protean planks and Royal Battleship kits.<br> Check out the wiki for Baby Yaga's House <a href="https://runescape.wiki/w/Baby_Yaga%27s_House" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/brightfire.png" class="question-img" alt="Brightfire potion Image">
        <p>It was Super antifire (4) and Prayer Renewal (4). They are one of the combination potions released with Prifddinas and require you to buy a recipe from Lady Meilyr for 600,000gp. <br> Check out the wiki for Brightfire potions <a href="https://runescape.wiki/w/Brightfire_potion#(6)" target="_blank">here!</a></p>`,
        messageWrong: `<h2>Oof! <i class="fas fa-frown"></i></h2><br><p>That is not correct! <br> Hint: The skill guide ingame provides all required levels for content within RuneScape. <i class="fas fa-smile-beam"></i></p>`
    },
    {
        //16
    ...
    },
    {
        ...
        answer4: 'London',
        correct: '3', //Cambridge
        messageCorrect: `<img src="assets/images/answers/jagex.png" class="question-img" alt="Jagex Image">
        <p>It was Cambridge. Founded in 1999, that was 22 years ago! They came up with Jagex as they wanted to be a company of **Ja**va **G**aming **Ex**perts specialzing in browser based Java games. They released RuneScape in January 2001 and it has only grown since. <br> Check out the wiki for  here <a href="https://en.wikipedia.org/wiki/Jagex" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        correct: '4', //
        messageCorrect: `<img src="assets/images/answers/tailoftwocats.png" class="question-img" alt=" Tail of Two Cats Image">
        <p>It was a Tail of Two Cats. During this quest you learn about the life of Bob the cat. Neite is his lover and you must find him items so he can woo her, you also complete tasks to help out Bob's owner, Unfert. <br> Check out the wiki for Tail of Two Cats <a href="https://runescape.wiki/w/A_Tail_of_Two_Cats" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        answer4: 'Farming',
        correct: '3', //Invention
        messageCorrect: `<img src="assets/images/answers/invention.png" class="question-img" alt="Invention Image">
        <p>It was Invention. To even unlock this skill you require level 80 in Divination, Smithing and Crafting. You can then start the invention tutorial north of Falador in the Invention guild. <br> Check out the wiki for Invention <a href="https://runescape.wiki/w/Invention" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        answer4: '81',
        correct: '3', //68
        messageCorrect: `<img src="assets/images/answers/fishingguild.png" class="question-img" alt="Fishing Guild Image">
        <p>It was 68. Once you have this Fishing level you can enter the guild north of the Ardougne lodestone. It provides a multitude of Fishing locations and access to the Deep Sea Fishing platform. <br> Check out the wiki for the Fishing Guild <a href="https://runescape.wiki/w/Fishing_Guild" target="_blank">here!</a></p>`,
        messageWrong: `<h2>Oof! <i class="fas fa-frown"></i></h2><br><p>That is not correct! <br> Hint: The skill guide ingame provides all required levels for content within RuneScape. <i class="fas fa-smile-beam"></i></p>`
    },
    {
        //22
        ...
        answer4: '80',
        correct: '2', //60
        messageCorrect: `<img src="assets/images/answers/yewtree.png" class="question-img" alt="Yew tree Image">
        <p>It was 60. Yews can be found in multiple locations around the world of Gielinor, most notably west of Catherby bank, south of Edgeville bank and in the Crwys district of Prifddinas. <br> Check out the wiki for Yew trees <a href="https://runescape.wiki/w/Yew" target="_blank">here!</a></p>`,
        messageWrong: `<h2>Oof! <i class="fas fa-frown"></i></h2><br><p>That is not correct! <br> Hint: The skill guide ingame provides all required levels for content within RuneScape. <i class="fas fa-smile-beam"></i></p>`
    },
    {
        //23
        ...
        messageCorrect: `<img src="assets/images/answers/excalibur.png" class="question-img" alt="Excalibur Image">
        <p>It was Merlin's Crystal. This is a quest in which you work with King Arthur to help free Merlin who, like all amazing magicians is stuck inside a crystal. <br> Check out the wiki for Excalibur <a href="https://runescape.wiki/w/Excalibur" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        answer4: 'Morytania',
        correct: '4', //Morytania
        messageCorrect: `<img src="assets/images/answers/darkmeyer.png" class="question-img" alt="Darkmeyer Image">
        <p>It was Morytania. After the Branches of Darkmeyer, you have access to this city and have access to the Blisterwood tree which can be used to create weapons which can damage vampyres. <br> Check out the wiki for Darkmeyer <a href="https://runescape.wiki/w/Darkmeyer" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/soulsplit.png" class="question-img" alt="Soul Split Image">
        <p>It was Temple at Senntisten. After completing this quest you can access to the ancient curses prayer book which contains many useful curses that are widely used in today's RuneScape, most notably the deflect prayers and superheat/light form. <br> Check out the wiki for Soul Split <a href="https://runescape.wiki/w/Soul_Split" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/wizardstower.png" class="question-img" alt="Wizard's Tower Image">
        <p>It was Wizard's Tower. You speak to these wizards and others in multiple quests including Rune Mysteries, Rune Memories and Imp Catcher. <br> Check out the wiki for the Wizard's Tower <a href="https://runescape.wiki/w/Wizards%27_Tower" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        answer4: 'Kharid-Et',
        correct: '4', //Kharid-Et
        messageCorrect: `<img src="assets/images/answers/smokecloud.png" class="question-img" alt="Smoke Cloud spell scroll Image">
        <p>It was Kharid-Et. It is found whilst excavating Culinarum debris. It can be excavated and restored at level 100 Archaeology. <br> Check out the wiki for the Smoke Cloud spell scroll <a href="https://runescape.wiki/w/%27Smoke_Cloud%27_spell_scroll_(damaged)" target="_blank">here!</a></p>`,
    ...
    },
    {
        ...
        messageCorrect: `<img src="assets/images/answers/jumper.png" class="question-img" alt="Jumper Image">
        <p>It was a node in Runespan. They require 54 Runecrafting as you receive law runes when siphoning from them. They appear on the upper floor and rarely on the middle floor. <br> Check out the wiki for Jumper's <a href="https://runescape.wiki/w/Jumper" target="_blank">here!</a></p>`,
